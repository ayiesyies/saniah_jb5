...
<head>
    ...
    <title>Detail Data Barang - (nama web)</title>
...
<body style="background: #f7fbff">
    ...
    <div class="section">
        <div class="container mt-5">
            <h1 class="text-center my-4" style="color: #1f0f0f; font-weight: bolder">SEMBAKO</h1>
            <a href="/produks" class="btn btn-md btn-success mb-3">DATA BARANG</a>
