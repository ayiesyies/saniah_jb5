            ...
            <div class="col-md-12">
                <div>
                    <h1 class="text-center my-4" style="font-weight: bolder"><a href="/"
                            style="text-decoration: none; color: #1f0f0f">SEMBAKO</a></h1>
                    <hr>
                </div>
                <div class="card border-0 shadow-sm rounded">
                    <div class="card-body">
                        <h4 class="text-center my-2">DATA BARANG</h4>
                        <a href="{{ route('produks.create') }}" class="btn btn-md btn-success mb-3">TAMBAH BARANG</a>
